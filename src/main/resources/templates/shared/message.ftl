<#macro message>
    <div id="message-container" class="space-y-2.5 transition-opacity duration-500 ease-in-out">
        ...
        <#if infoMessage??>
            <div class="flex items-center gap-3 bg-blue-50 border border-blue-100 px-4 py-3 rounded-lg mb-3">
        ...
        <#if errorMessage??>
            <div class="flex items-center gap-3 bg-red-50 border border-red-100 px-4 py-3 rounded-lg mb-3">
