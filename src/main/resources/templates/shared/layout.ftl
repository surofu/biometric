<#macro layout title="" showNavbar=true bodyClass="" selectedPage="-1">
    ...
    <head>
        ...
        <meta name="description" content="Биометрик — платформа для персонального мониторинга показателей здоровья. Отслеживайте важные метрики: давление, пульс, уровень глюкозы и другие.">
        <meta name="keywords" content="здоровье, мониторинг, показатели, давление, пульс, глюкоза, трекер здоровья, Биометрик">
