...
<@adminLayoutMacros.adminLayout title="Категории" selectedPage="indicator-categories">
    <div class="py-6 sm:py-8 pb-16">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            <div class="min-w-0">
                <h1 class="text-xl sm:text-2xl font-semibold text-slate-800 tracking-tight wrap-break-word">Категории
                    анализов</h1>
                    ...
                    <div class="p-4 search-item" data-search="${item.name?lower_case}">
                        <div class="flex justify-between items-center gap-4">
                            ...
                            <div class="flex gap-2 shrink-0">
                                <a href="/admin/indicator-categories/${item.id}/edit"
                                ...
                                <form method="post" action="/admin/indicator-categories/${item.id}"
            ...
            <table class="hidden sm:table min-w-full">
                ...
                <#list categories as item>
                    <tr class="hover:bg-slate-50/50 transition-colors search-item"
                        ...
                        <td class="px-6 py-4 text-sm font-semibold text-slate-800 wrap-break-word">${item.name}</td>
