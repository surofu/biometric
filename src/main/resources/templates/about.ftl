    ...
    <div class="min-h-screen bg-white">
        <div class="container max-w-2xl mx-auto px-6 pt-6 pb-24">
            ...
            <div class="space-y-10">
                <section>
                    ...
                    <p class="text-slate-600 leading-relaxed text-sm md:text-base">
                        Биометрик — это персональный журнал медицинских данных. Мы убрали всё лишнее, чтобы вы могли
                        сфокусироваться на главном: отслеживании динамики анализов и поддержании своего здоровья в
                        норме.
                    </p>
                </section>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div class="p-6 border border-slate-100 rounded-2xl bg-slate-50/30">
                        ...
                        <p class="text-xs text-slate-500 leading-normal">Добавляйте результаты анализов и измерений за
                            несколько секунд.</p>
                    </div>
                    ...
                    <div class="p-6 border border-slate-100 rounded-2xl bg-slate-50/30">
                        ...
                        <p class="text-xs text-slate-500 leading-normal">Визуальное представление изменений ваших
                            результатов анализов на графиках.</p>
                    </div>
                ...
                <section
                        class="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-slate-100">
                    <div class="flex items-center gap-2 text-xs text-slate-400 font-medium">
                        <span>Создано</span>
                        <a href="https://github.com/surofu" target="_blank"
                           class="text-emerald-600 hover:text-emerald-700 transition-colors underline underline-offset-4 decoration-emerald-200">@surofu</a>
                    </div>

                    <a href="https://github.com/surofu/biometric" target="_blank"
                       class="flex items-center gap-2 text-xs text-slate-500 hover:text-slate-800 transition-colors group">
            ...
            <div class="mt-12 text-center">
                <a href="/"
                   class="inline-flex items-center gap-2 text-xs font-medium text-slate-300 hover:text-slate-500 transition-colors">
