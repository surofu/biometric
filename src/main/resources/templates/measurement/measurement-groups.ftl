...
<#list page.content() as group>
    <details class="measurement-group bg-white rounded-lg border border-gray-200 overflow-hidden" <#if (isFirstPage && group?is_first)>open</#if>>
        <summary class="bg-gray-50 px-4 py-3 border-b border-gray-200 flex justify-between items-center keysetCursor-pointer hover:bg-gray-300 transition-colors list-none [&::-webkit-details-marker]:hidden">
