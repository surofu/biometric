            ...
            <div class="grid grid-cols-[1fr_auto] gap-2 w-full">
                <div class="relative">
                    <input type="text" id="searchInput"
                           ...
                           value="${search!''}"
                           class="w-full sm:w-64 pl-9 pr-4 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all"/>
