            ...
            <div class="max-w-md mx-auto">
                <div class="flex flex-col items-center gap-4">
                    <div class="flex items-center gap-6">
                        <a href="/privacy-policy" class="text-xs text-gray-400 hover:text-emerald-600 transition-colors">Конфиденциальность</a>
                        <a href="/terms-of-service" class="text-xs text-gray-400 hover:text-emerald-600 transition-colors">Условия</a>
                        <a href="mailto:support@biometric.by" class="text-xs text-gray-400 hover:text-emerald-600 transition-colors">Поддержка</a>
                    </div>
